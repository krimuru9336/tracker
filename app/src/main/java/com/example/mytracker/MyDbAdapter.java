...
//        contentValues.put(MyDbHelper.TIME, time);
    ...
    public ArrayList<ArrayList<Object>> getData() {
        ...
        String[] columns = {MyDbHelper.UID, MyDbHelper.LATITUDE, MyDbHelper.LONGITUDE};
...
//                tempList.add(cursor.getString(cursor.getColumnIndexOrThrow(MyDbHelper.TIME)));
    ...
    static class MyDbHelper extends SQLiteOpenHelper {
        ...
        private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                " (" + UID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + LATITUDE + " DECIMAL(3,2) ," + LONGITUDE + " DECIMAL(3,2);";
